...
static const char* brightup[] = {"brightnessctl", "set", "+5%"};
static const char* brightdown[] = {"brightnessctl", "set", "5%-"};
...
static const char *fonts[]          = { "FiraCode Nerd Font Mono:pixelsize=14", "JoyPixels:pixelsize=11:antialias=true:autohint=true"};
